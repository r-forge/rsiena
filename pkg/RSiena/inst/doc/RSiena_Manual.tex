...
This version was renewed for \RS version 1.1-250.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-250) and an R-forge revision
...
\item \sfn{setEffect()}, \sfn{updateTheta()}, and \sfn{prevAns} in \sfn{siena07()}
     now also work properly for unspecified interactions.
