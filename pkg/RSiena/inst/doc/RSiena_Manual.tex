...
This version was renewed for \RS version 1.1-269.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-269) and an R-forge revision
...
(Programmers should consult the changeLog file in the source code on CRAN or in
the R-forge repository.)
\begin{small}
\begin{itemize} % Also update version number in abstract

\item 2014-04-13 R-Forge Revisions 267-269.
...
\begin{itemize}
\item Added function sienaRI() for assessment of relative importance of effects,
...
\item Corrected bug when printing siena object with symmetric network;
     and in \sfn{varDyadCovar()} corrected a bug occurring when calling it 
     with a named list.      
\end{itemize}


\item Internal changes in the code version 1.1-255 to 1.1-267 (see changeLog).
