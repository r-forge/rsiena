...
\hyphenation{Snij-ders Duijn Huis-man Steg-lich Schwein-ber-ger siena-Data-Create-From-Session
             siena-Data-Create siena-Com-position-Change}
...
This version was renewed for \RS version 1.1-251.
\end{abstract}
...
Ruth M. Ripley, Tom A.B. Snijders, Zs\'{o}fia Boda,
 Andr\'{a}s V\"{o}r\"{o}s, and Paulina Preciado, 2013.
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-251) and an R-forge revision
...
Although the fit statistics of the GWESP effects approximate those
for transitive ties for $\alpha=0$ and for transitive triplets
for large $\alpha$, the estimates are not the same because some other
calculations are done differently. This is still open to further
developments.
