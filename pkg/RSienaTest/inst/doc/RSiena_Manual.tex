...
This version was renewed for \RS version 1.1-246.
\end{abstract}
...
\noindent
Ruth M. Ripley, Tom A.B. Snijders, Zsofia B\'{o}da,
...
\subsubsection[Types of {\saom}s: \protect\newline
...
\begin{enumerate}
   ...
   be two node sets.
	...
	\item	Use functions \sfn{inludeEffects()}, \sfn{setEffect()} and
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-244) and an R-forge revision
...
\item For the analysis of diffusion of innovations,
 ...
 \[ \exp\Big( \alpha_h \, \big( \sum_j z_j \, x_{ij}\big)/\big(\sum_j x_{ij} \big) \Big)\, . \]
  ...
  proportional hazards model. See \citet{Greenan14}.
...
\item 2013-10-09 R-Forge Revision 245
...
\begin{itemize}
   ...
   \item Start of the manual reorganized and partially rewritten (with help from
     Zsofia B\'{o}da and Andr\'{a}s V\"{o}r\"{o}s); instructions for
