...
This version was renewed for \RS version 1.1-253.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-253) and an R-forge revision
...
\item No noticeable changes from version 1.1-251 to 1.1-253.
