...
\item \emph{in-isolate popularity effect}, (\texttt{inIsolatePop}), the effect of
      being tied to actors who further have no incoming ties
      (the fact that such a tie does exist will give the other actor
      an in-degree of 1),\\
$s^{\rm net}_{i\vit}(x, z) = \sum_j x_{ij}\, I\{x_{+j} = 1 \} $ .
...
$s^{\rm net}_{i\vit}(x, z) = \sum_j x_{ij}\, I\{x_{+j} = 1, x_{j+} = 0 \} $ .
      ...
      isolate popularity effect expressed the tendency for ego
      ...
      whereas for the in-isolate and isolate popularity effect the agency
      is in others not
...
\begin{small}
\begin{itemize}
\item 2013-08-22 R-forge revision 241
