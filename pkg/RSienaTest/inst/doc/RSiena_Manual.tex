...
\sfn{diagonalize = 1} in the call of \sfn{sienaModelCreate};
...
created by \sfn{sienaModelCreate()} with \sfn{maxlike=TRUE}.
...
variables must be renamed in the call of \textsf{sienaModelCreate};
...
This begins (in reverse order) at end October 2009, and only details changes
