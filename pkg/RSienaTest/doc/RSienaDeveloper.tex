...
\item You may get warning messages from CYGWIN. This is caused by a recent
  ...
  variable \verb|CYGWIN| to the value \verb|nodosfilewarnings|. (CYGWIN may also
...
to clear out all the .o's and the dll. (Currently \verb|R CMD build| clears out
.o's but it will not from R 2.13.0)
