...
\[
  \exp\big(f^{\rm net}(x_b) - f^{\rm net}(x_a)\big) \ .
\]
...
\begin{small}
\begin{itemize}
\item 2011-06-13 R-forge 156: fixed bug removing density effect for bipartite
  networks with some only waves up or down only.
\item 2011-06-12 R-forge 155:
\begin{itemize}
...
\end{itemize}
\item 2011-05-27 R-forge 150: Removed effect for an absolutely constant covariate
with two networks.
