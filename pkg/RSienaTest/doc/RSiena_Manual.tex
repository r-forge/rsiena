...
This version was renewed for \RS version 1.2-9.
\end{abstract}
...
\url{http://cran.r-project.org/web/packages/RSiena/} .\\
            ...
            the root name of the file is \texttt{RSienaTest\_1.2-9}, and filling in the correct path name.
            ...
            for Windows:\\
             \texttt{install.packages("pathname to RSienaTest\_1.2-9.zip", repos = NULL, type="binary")}\\
            for Mac:\\
             \texttt{install.packages("pathname to RSienaTest\_1.2-9.tgz", repos = NULL, type="binary")}
             \item In \R from source:\\
            \texttt{install.packages("RSienaTest\_1.2-9.tar.gz", repos = NULL, type="source")}
            \item In \text{command.com} or in batch mode (Windows) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2-9.zip}
            \item In the terminal (Mac) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2-9.tgz}
            \item In \text{command.com} or in batch mode (Windows) or in the terminal (Mac) from source:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2-9.tar.gz}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.2-9) and an R-Forge revision
...
all other prior means as $0$, and all prior variances as $0.16$,
corresponding to prior standard deviations of $0.4$.
...
minus the overall mean\footnote{More precisely:
