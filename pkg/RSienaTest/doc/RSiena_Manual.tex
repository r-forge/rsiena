...
Books are in preparation \citep{SNDE,AMAND}.
...
This is a manual for \rs, which also may be called \SI version 4.1.2;
...
The specification of fixed vs.\ randomly varying is done in the function
\sfn{setEffect}.
...
\item To the file \textsf{src$\backslash$sources.list}, the item
...
\begin{itemize}
 ...
 \item For effects \texttt{inPopX, outPopX, inActX, outActX, sameXInPop, sameXOutAct,
     ...
     changed \texttt{interaction2} to `' (was `1', erroneously)
