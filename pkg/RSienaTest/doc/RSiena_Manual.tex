...
This version was renewed for \RS version 1.1-292.
\end{abstract}
...
\begin{enumerate}
	...
	\item	Install the package \RS or \sfn{RSienaTest}, with dependencies.
            ...
            the root name of the file is \texttt{RSienaTest\_1.1-292}, and filling in the correct path name.
            ...
            for Windows:\\
             \texttt{install.packages("pathname to RSienaTest\_1.1-292.zip", repos = NULL, type="binary")}\\
            for Mac:\\
             \texttt{install.packages("pathname to RSienaTest\_1.1-292.tgz", repos = NULL, type="binary")}
             \item In \R from source:\\
            \texttt{install.packages("RSienaTest\_1.1-292.tar.gz", repos = NULL, type="source")}
            \item In \text{command.com} or in batch mode (Windows) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.1-292.zip}
            \item In the terminal (Mac) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.1-292.tgz}
            \item In \text{command.com} or in batch mode (Windows) or in the terminal (Mac) from source:\\
            \texttt{R CMD INSTALL RSienaTest\_1.1-292.tar.gz}
...
\item[Check your version of \RS]
  ...
  identified by a version number (e.g.\ 1.1-292) and an R-Forge revision
...
\item First do an estimation with the default parameters
    ...
    and \sfn{firstg} clearly less than the default 0.2,
    e.g., about half the smallest standard error reported in the first estimation.
...
function \sfn{monitor()} of package \sfn{stan} or with the
...
\item 2016-05-22 Revision 292 (beta version).

Changes in RSiena and RSienaTest:
\begin{itemize}
   \item This manual taken out of the source code distribution;
   it can be downloaded from \\
\href{http://www.stats.ox.ac.uk/~snijders/siena/RSiena_Manual.pdf}
{\texttt{http://www.stats.ox.ac.uk/~snijders/siena/RSiena\_Manual.pdf}}.
   \item New effects  \texttt{totAltEgoX}, \texttt{totAltAltX}, \texttt{egoSqX},
     ...
     \texttt{totSimmelianAlt},  \texttt{avWalt},  \texttt{totWAlt}.
   ...
   \item \sfn{print01Report()} gives report for structurally absent actors
     irrespective of whether diagonal values are 0, 10, or NA.
