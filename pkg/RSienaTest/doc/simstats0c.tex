...
\remark{THIS IS INCOMPLETE, DOES NOT TAKE INTO ACCOUNT ENDOWMENT FUNCTION.}
\ENDIF
\IF{subtype not 3}
...
\remark{IN OTHER WORDS (IF MY INTERPRETATION IS CORRECT), THE SUMS OF ACTORS IN THE FOLLOWING
ARE ONLY OVER PERMITTED ACTORS; THIS EXCLUDES INACTIVE ACTORS, BUT FOR UPONLY,
DOWNONLY, HIGHER, DISJOINT, ATLEASTONE, SOME ADDITIONAL ACTORS MAY NEED TO BE EXCLUDED.
GENERALLY, THE SUM IS ONLY OVER THE CONSIDERED ALTERNATIVES.}
