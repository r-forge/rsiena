...
\begin{equation}
           \nnm{tconv.max} \,=\, \max_{b}
           \left\{ \frac{b' \big(\bar{s}_j - s^{\rm{obs}}\big)}
...
\[
 ...
 %          {\sqrt{b' \Sigma b}} \right\} \,=\,
  \max_{c} \left\{ \frac{c' \, \Sigma^{-1/2}  \big(\bar{s}_j - s^{\rm{obs}}\big)}
           {\sqrt{c'c\,}} \right\} \,=\,
           \big(\bar{s}_j - s^{\rm{obs}}\big)'\,
           \Sigma^{-1}  \big(\bar{s}_j - s^{\rm{obs}}\big) \ .
\]
